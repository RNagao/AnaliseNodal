...
for i in range(len(content)):
    ...
    if nome == "R": #resistor
        ...
        G[int(componentsData[i][1])][int(componentsData[i][1])] += 1j*w*float(componentsData[i][3])
        G[int(componentsData[i][1])][int(componentsData[i][2])] += -1j*w*float(componentsData[i][3])
        G[int(componentsData[i][2])][int(componentsData[i][1])] += -1j*w*float(componentsData[i][3])
        G[int(componentsData[i][2])][int(componentsData[i][2])] += 1j*w*float(componentsData[i][3])

    elif nome == "L": #Indutor
        G[int(componentsData[i][1])][int(componentsData[i][1])] += 1/(1j*w*float(componentsData[i][3]))
        G[int(componentsData[i][1])][int(componentsData[i][2])] += -1/(1j*w*float(componentsData[i][3]))
        G[int(componentsData[i][2])][int(componentsData[i][1])] += -1/(1j*w*float(componentsData[i][3]))
        G[int(componentsData[i][2])][int(componentsData[i][2])] += 1/(1j*w*float(componentsData[i][3]))
